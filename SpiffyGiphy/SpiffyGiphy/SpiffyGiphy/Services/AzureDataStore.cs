...
{
    public class AzureDataStore : IDataStore<FavoriteGif>
    {
        ...
        bool isInitialized;
        IMobileServiceSyncTable<FavoriteGif> itemsTable;
        ...
        public async Task<bool> AddItemAsync(FavoriteGif item)
        {
            await InitializeAsync();
            await PullLatestAsync();
        ...
        public async Task<bool> UpdateItemAsync(FavoriteGif item)
        {
            await InitializeAsync();
        ...
        public async Task<bool> DeleteItemAsync(FavoriteGif item)
        {
            await InitializeAsync();
            await PullLatestAsync();
        ...
        public async Task InitializeAsync()
        {
            ...
            store.DefineTable<FavoriteGif>();
            await MobileService.SyncContext.InitializeAsync(store, new MobileServiceSyncHandler());
            itemsTable = MobileService.GetSyncTable<FavoriteGif>();
        ...
        public async Task<bool> PullLatestAsync()
        {
            ...
            try
            {
                await itemsTable.PullAsync($"all{typeof(FavoriteGif).Name}", itemsTable.CreateQuery());
            }
            catch (Exception ex)
            {
